                    ...
                    {dreamCloudFallback ? (
                      ...
                      >
                        ...
                        <Pressable
                          ...
                          style={({ pressed }) => [
                            styles.cloudFallbackButton,
                            pressed && styles.pressed,
                            transformingDream && styles.disabled,
                          ]}
                        >
...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 76, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, paddingVertical: 10 },
  iconButton: { width: 48, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center' },
  headerCopy: { flex: 1, paddingRight: 48 },
  pageTitle: { fontSize: 21, lineHeight: 27, fontWeight: '800', textAlign: 'center', letterSpacing: -0.25 },
  pageSubtitle: { fontSize: 12.5, lineHeight: 18, textAlign: 'center', marginTop: 2, letterSpacing: 0.1 },
  scrollContent: { paddingHorizontal: 20, paddingTop: 28, paddingBottom: 128 },
  content: { width: '100%', maxWidth: 720, alignSelf: 'center' },
  introRow: { flexDirection: 'row', alignItems: 'flex-start' },
  featureIcon: { width: 52, height: 52, borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  sectionTitle: { fontSize: 24, lineHeight: 31, fontWeight: '800', letterSpacing: -0.35 },
  sectionBody: { fontSize: 15, lineHeight: 23, marginTop: 5, letterSpacing: 0 },
  wakePanel: { borderWidth: 1, borderRadius: 22, padding: 20, marginTop: 20 },
  wakeText: { fontSize: 24, lineHeight: 34, fontWeight: '700', letterSpacing: -0.2 },
  emptyWake: { minHeight: 88, alignItems: 'center', justifyContent: 'center' },
  emptyWakeText: { fontSize: 14, fontWeight: '600', marginTop: 7, letterSpacing: 0 },
  buttonRow: { flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: -5, marginTop: 15 },
  smallButton: { minHeight: 48, borderRadius: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 15, margin: 5 },
  ...
  fieldLabel: { fontSize: 14, lineHeight: 20, fontWeight: '800', marginTop: 22, marginBottom: 10, letterSpacing: 0.1 },
  firstLabel: { marginTop: 0 },
  timeRow: { paddingRight: 4 },
  timeChip: { minWidth: 72, minHeight: 48, borderRadius: 16, borderWidth: 1, alignItems: 'center', justifyContent: 'center', marginRight: 9 },
  timeText: { fontSize: 13, fontWeight: '800', letterSpacing: 0 },
  switchRow: { minHeight: 68, borderWidth: 1, borderRadius: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, marginTop: 16 },
  ...
  honestyNote: { borderRadius: 16, padding: 14, flexDirection: 'row', alignItems: 'flex-start', marginTop: 10 },
  honestyText: { flex: 1, fontSize: 12, lineHeight: 18, marginLeft: 8, letterSpacing: 0 },
  divider: { height: 1, marginVertical: 34 },
  bonusHeader: { flexDirection: 'row', alignItems: 'center' },
  eyebrow: { fontSize: 11, lineHeight: 16, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.2 },
  bonusTitle: { fontSize: 24, lineHeight: 31, fontWeight: '800', marginTop: 3, letterSpacing: -0.35 },
  expandButton: { width: 48, height: 48, borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginLeft: 14 },
  ...
  savedDreamsRow: { paddingTop: 10, paddingRight: 20 },
  savedDream: { width: 252, minHeight: 106, borderWidth: 1, borderRadius: 18, padding: 15, marginRight: 10 },
  ...
  bonusPanel: { borderTopWidth: 1, marginTop: 20, paddingTop: 24 },
  inputShell: { borderWidth: 1, borderRadius: 20, overflow: 'hidden' },
  input: { minHeight: 132, maxHeight: 250, padding: 16, fontSize: 16, lineHeight: 24, letterSpacing: 0 },
  inputFooter: { minHeight: 52, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14 },
  voiceButton: { minHeight: 48, flexDirection: 'row', alignItems: 'center', paddingRight: 10 },
  ...
  cloudNotice: { minHeight: 60, borderRadius: 16, flexDirection: 'row', alignItems: 'center', padding: 14, marginTop: 18 },
  ...
  choiceChip: { minHeight: 48, borderWidth: 1, borderRadius: 16, justifyContent: 'center', paddingHorizontal: 15, marginRight: 8 },
  choiceText: { fontSize: 12, fontWeight: '700', letterSpacing: 0 },
  transformButton: { marginTop: 20 },
  resultPanel: { borderWidth: 1, borderRadius: 24, padding: 20, marginTop: 22 },
  ...
  cloudFallback: { borderRadius: 16, padding: 14, marginTop: 14 },
  cloudFallbackText: { fontSize: 11, lineHeight: 17, letterSpacing: 0 },
  cloudFallbackButton: { minHeight: 48, justifyContent: 'center', alignSelf: 'flex-start' },
  cloudFallbackAction: { fontSize: 12, lineHeight: 18, fontWeight: '800', letterSpacing: 0 },
  resultDivider: { height: 1, marginVertical: 15 },
  resultText: { fontSize: 24, lineHeight: 34, fontWeight: '700', marginTop: 6, letterSpacing: -0.2 },
  resultActions: { flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: -4, marginTop: 13 },
  resultButton: { minHeight: 48, borderRadius: 16, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, margin: 4 },
  ...
  mirrorConsentIcon: { width: 40, height: 40, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  ...
  practiceButton: { minHeight: 52, borderTopWidth: 1, flexDirection: 'row', alignItems: 'center', marginTop: 16, paddingTop: 14 },
  practiceText: { fontSize: 13, lineHeight: 19, fontWeight: '800', marginLeft: 7, letterSpacing: 0 },
  deleteDreamButton: { minHeight: 48, flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  ...
  modalSheet: { width: '100%', maxWidth: 720, height: '82%', borderWidth: 1, borderRadius: 26, overflow: 'hidden' },
  modalHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 20, paddingBottom: 14 },
  modalTitle: { fontSize: 23, lineHeight: 29, fontWeight: '800', letterSpacing: -0.25 },
  modalBody: { fontSize: 13, lineHeight: 19, marginTop: 2, letterSpacing: 0 },
  pickerList: { paddingHorizontal: 16, paddingBottom: 28 },
  customWake: { borderWidth: 1, borderRadius: 18, padding: 15, marginBottom: 14 },
  ...
  pickerRow: { minHeight: 92, borderWidth: 1, borderRadius: 18, padding: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center' },
  sourceTag: { borderRadius: 10, paddingHorizontal: 8, paddingVertical: 5, marginRight: 11 },
